#!/usr/bin/env python3
"""Fake codex: normal completion. Exit 0."""
...
emit({"timestamp": "2026-09-06T00:00:02Z", "ordinal": 2, "type": "response_item",
      "payload": {"type": "message", "content": [{"type": "output_text", "text": "Done!"}]}})
emit({"timestamp": "2026-09-06T00:00:03Z", "ordinal": 3, "type": "event_msg",
